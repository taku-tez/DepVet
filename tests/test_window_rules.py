...
async def test_diff_stats_large_addition_signal():
    ...
    stats = DiffStats(
        files_changed=3, lines_added=500, lines_removed=10, binary_files=[], new_files=[], deleted_files=[]
    )
...
async def test_diff_stats_binary_added_signal():
    ...
    stats = DiffStats(
        files_changed=2, lines_added=10, lines_removed=5, binary_files=["lib/evil.so"], new_files=[], deleted_files=[]
    )
    signals = await analyze_diff_stats_signals(stats, "mypkg", "pypi")
...
async def test_diff_stats_no_signals_for_normal_change():
    ...
    stats = DiffStats(
        files_changed=2, lines_added=15, lines_removed=10, binary_files=[], new_files=[], deleted_files=[]
    )
